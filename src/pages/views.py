...
def count(request):
    ...
    if len(fulltext) == 0 and len(fulltext) < 1000:
        ...
        return render(request, 'pages/count.html', {'fulltext':fulltext, 'desc2':desc2, 'ease':ease, 'rtime':rtime})
    elif 30 <= ease <= 50:
        ...
        return render(request, 'pages/count.html', {'fulltext':fulltext,'desc3':desc3, 'ease':ease, 'rtime':rtime})
    elif 50 <= ease <= 60:
        desc4 = "this text is fairly difficult to read. View the complete readability table under 'Readability Models'."
        return render(request, 'pages/count.html', {'fulltext':fulltext,'desc4':desc4, 'ease':ease, 'rtime':rtime})
    elif 60 <= ease <= 70:
        ...
        return render(request, 'pages/count.html', {'fulltext':fulltext,'desc6':desc6, 'ease':ease, 'rtime':rtime})
    elif 70 <= ease <= 80:
        ...
        return render(request, 'pages/count.html', {'fulltext':fulltext,'desc7':desc7, 'ease':ease, 'rtime':rtime})
    elif 80 <= ease <= 100:
